$CONDA_EXE = 'X:/nsi/conda_install/Scripts/conda.exe'
$_CONDA_EXE = 'X:/nsi/conda_install/Scripts/conda.exe'
try:
    del $_CE_M
except KeyError:
    pass
try:
    ...
    pass
$CONDA_PYTHON_EXE = 'X:/nsi/conda_install/python.exe'
$_CONDA_ROOT = 'X:/nsi/conda_install'
