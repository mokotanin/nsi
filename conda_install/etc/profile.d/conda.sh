export CONDA_EXE="$(cygpath 'X:/nsi/conda_install\Scripts\conda.exe')"
export _CONDA_EXE="$(cygpath 'X:/nsi/conda_install\Scripts\conda.exe')"
export _CE_M=''
export _CE_CONDA=''
export CONDA_PYTHON_EXE="$(cygpath 'X:/nsi/conda_install\python.exe')"
export _CONDA_ROOT="$(cygpath 'X:/nsi/conda_install')"
