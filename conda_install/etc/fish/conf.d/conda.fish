set -gx CONDA_EXE (cygpath "X:/nsi/conda_install\Scripts\conda.exe");
set -gx _CONDA_EXE (cygpath "X:/nsi/conda_install\Scripts\conda.exe");
set -e _CE_M || true;
set -e _CE_CONDA || true;
set -gx CONDA_PYTHON_EXE (cygpath "X:/nsi/conda_install\python.exe");
set -gx _CONDA_ROOT (cygpath "X:/nsi/conda_install");
