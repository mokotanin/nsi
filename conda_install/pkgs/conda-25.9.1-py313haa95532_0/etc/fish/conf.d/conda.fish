set -gx CONDA_EXE (cygpath "C:\miniconda3\conda-bld\conda_1760457894461\_h_env\Scripts\conda.exe");
set -gx _CONDA_EXE (cygpath "C:\miniconda3\conda-bld\conda_1760457894461\_h_env\Scripts\conda.exe");
set -e _CE_M || true;
set -e _CE_CONDA || true;
set -gx CONDA_PYTHON_EXE (cygpath "C:\miniconda3\conda-bld\conda_1760457894461\_h_env\python.exe");
set -gx _CONDA_ROOT (cygpath "C:\miniconda3\conda-bld\conda_1760457894461\_h_env");
