#  tests for pyjwt-2.10.1-py313haa95532_0 (this is a generated file);
print('===== testing package: pyjwt-2.10.1-py313haa95532_0 =====');
...
print('===== pyjwt-2.10.1-py313haa95532_0 OK =====');
print("import: 'jwt'")
import jwt
