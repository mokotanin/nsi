...
# installed.
TCL_PREFIX='X:/nsi/conda_install\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='X:/nsi/conda_install\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='X:/nsi/conda_install\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IX:/nsi/conda_install\Library\include'
...
TCL_PACKAGE_PATH='X:/nsi/conda_install\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LX:/nsi/conda_install\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='X:/nsi/conda_install\Library\lib\tclstub86.lib'
