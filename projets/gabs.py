...
def Grille():
    for i in range(1, 3):
        canvas.create_line(0, i*200, 600, i*200)
        canvas.create_line(i*200, 0, i*200, 600)
...
BouttonRejouer = Button(frame, text='Rejouer', command=Relance)
BouttonRejouer.pack(side=LEFT,padx=30, pady=3)

BouttonQuitter = Button(frame, text='Quitter', command=window.destroy)
BouttonQuitter.pack(side=LEFT,padx=0, pady=3)
